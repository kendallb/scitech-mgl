...
#if defined(_WIN32) && !defined(_WINDEF_) && !defined(_WINDEF_H) && !defined(MESA)
...
#		pragma message( "----: being multiply defined you should include WINDOWS.H prior to gl/glut.h" )
#	endif
...
#if defined(_WIN32) && !defined(_WINGDI_) && !defined(_WINGDI_H) && !defined(MESA)
#	if !defined(MESA_MINWARN)
...
#		pragma message( "----: defined you should include WINDOWS.H prior to gl/glut.h" )
#	endif
