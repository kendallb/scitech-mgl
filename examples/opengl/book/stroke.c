...
void myinit (void)
{
    ...
    base = glGenLists (128);
    glListBase(base);
    glNewList(base+'A', GL_COMPILE); drawLetter(dataA); glEndList();
    glNewList(base+'E', GL_COMPILE); drawLetter(dataE); glEndList();
    glNewList(base+'P', GL_COMPILE); drawLetter(dataP); glEndList();
    glNewList(base+'R', GL_COMPILE); drawLetter(dataR); glEndList();
    glNewList(base+'S', GL_COMPILE); drawLetter(dataS); glEndList();
