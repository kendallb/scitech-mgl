...
void accFrustum(GLdouble left, GLdouble right, GLdouble bottom, 
    GLdouble top, GLdouble anear, GLdouble afar, GLdouble pixdx, 
    GLdouble pixdy, GLdouble eyedx, GLdouble eyedy, GLdouble focus)
{
    ...
    dx = -(pixdx*xwsize/(GLdouble) viewport[2] + eyedx*anear/focus);
    dy = -(pixdy*ywsize/(GLdouble) viewport[3] + eyedy*anear/focus);
...
void accPerspective(GLdouble fovy, GLdouble aspect, 
    GLdouble anear, GLdouble afar, GLdouble pixdx, GLdouble pixdy, 
    GLdouble eyedx, GLdouble eyedy, GLdouble focus)
{
    ...
    accFrustum (left, right, bottom, top, anear, afar,
