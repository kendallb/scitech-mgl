...
set LIB=%SCITECH_LIB%\LIB\RELEASE\WIN32\VC7;%MSVCDir%\LIB;%MSVCDir%\LIB;%MSVCDir%\PlatformSDK\lib;.
echo Release build enabled.
goto setvars

:checked_build
set LIB=%SCITECH_LIB%\LIB\DEBUG\WIN32\VC7;%MSVCDir%\LIB;%MSVCDir%\LIB;%MSVCDir%\PlatformSDK\lib;.
echo Checked debug build enabled.
goto setvars

:setvars
set C_INCLUDE=%MSVCDir%\INCLUDE;%MSVCDir%\PlatformSDK\include;
...
echo Visual C++.NET 7.0 32-bit Windows console compilation environment set up
