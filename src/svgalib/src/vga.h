...
/* The following modes have been introduced in svgalib 1.4.0 */
...
#define G320x400x32K 75
#define G320x400x64K 76
#define G320x400x16M 77
#define G320x400x16M32 78

#define G640x400x256 79
#define G640x400x32K 80
#define G640x400x64K 81
#define G640x400x16M 82
#define G640x400x16M32 83

#define G320x480x256 84
#define G320x480x32K 85
#define G320x480x64K 86
#define G320x480x16M 87
#define G320x480x16M32 88

#define G720x540x256 89
#define G720x540x32K 90
#define G720x540x64K 91
#define G720x540x16M 92
#define G720x540x16M32 93

#define G848x480x256 94
#define G848x480x32K 95
#define G848x480x64K 96
#define G848x480x16M 97
#define G848x480x16M32 98

#define G1072x600x256 99
#define G1072x600x32K 100
#define G1072x600x64K 101
#define G1072x600x16M 102
#define G1072x600x16M32 103

#define G1280x720x256 104
#define G1280x720x32K 105
#define G1280x720x64K 106
#define G1280x720x16M 107
#define G1280x720x16M32 108

#define G1360x768x256 109
#define G1360x768x32K 110
#define G1360x768x64K 111
#define G1360x768x16M 112
#define G1360x768x16M32 113

#define G1800x1012x256 114
#define G1800x1012x32K 115
#define G1800x1012x64K 116
#define G1800x1012x16M 117
#define G1800x1012x16M32 118

#define G1920x1080x256 119
#define G1920x1080x32K 120
#define G1920x1080x64K 121
#define G1920x1080x16M 122
#define G1920x1080x16M32 123

#define G2048x1152x256 124
#define G2048x1152x32K 125
#define G2048x1152x64K 126
#define G2048x1152x16M 127
#define G2048x1152x16M32 128

#define G2048x1536x256 129
#define G2048x1536x32K 130
#define G2048x1536x64K 131
#define G2048x1536x16M 132
#define G2048x1536x16M32 133

#define G512x480x256 134
#define G512x480x32K 135
#define G512x480x64K 136
#define G512x480x16M 137
#define G512x480x16M32 138

#define G400x600x256 139
#define G400x600x32K 140
#define G400x600x64K 141
#define G400x600x16M 142
#define G400x600x16M32 143
