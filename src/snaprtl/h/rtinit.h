...
*  ========================================================================
*
* Description:  Data for run-time initialization/finalization.
*
****************************************************************************/
...
#define __RTINIT_H__
  ...
  #else
    #define   __TGT_SYS   __TGT_SYS_PPC_SYSV
    typedef unsigned      __type_rtp;
    typedef unsigned      __type_pad;
    typedef void          (*__type_rtn)( void );
  #endif
  ...
  #define   __TGT_SYS   __TGT_SYS_AMD64_SYSV
  typedef unsigned      __type_rtp;
  typedef unsigned      __type_pad;
  typedef void          (*__type_rtn)( void );
#elif defined(__MIPS__)
  #define   __TGT_SYS   __TGT_SYS_MIPS_SYSV
  typedef unsigned      __type_rtp;
  typedef unsigned      __type_pad;
  typedef void          (*__type_rtn)( void );
...
#pragma pack()
  ...
  #define YIXI( seg, label, routine, priority ) \
    struct rt_init __attribute__ ((section(seg))) label = \
    { 0, priority, routine };

#elif defined(__386__) || defined(__AXP__) || defined(__PPC__)
