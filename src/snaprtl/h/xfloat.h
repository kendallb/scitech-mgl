...
*  ========================================================================
*
* Description:  Internal data structures and routines to support double 
*               or long double floating point numbers.
*
****************************************************************************/
...
// Note that big endian systems, we need to index memory differently!
typedef struct {                // This layout matches Intel 8087
  #ifdef _LONG_DOUBLE_
    unsigned int  low_word;     // - low word of fraction
    unsigned int  high_word;    // - high word of fraction
    ...
    union {
        ...
        unsigned int   hi_word; // - so we can access bits
        unsigned int   lo_word;
    #else
        unsigned int   lo_word; // - so we can access bits
