...
drivertype PACKED24_driver = {
    MGL_PACKED24NAME,
    "SciTech SNAP Graphics 24bpp Packed Pixel Driver",
...
{
    return PM_calloc(1,sizeof(PACKED24_state));
}
...
****************************************************************************/
void MGLAPI PACKED24_makeCurrent(
    MGLDC *dc,
    MGLDC *oldDC,
    ibool partial)
{
    ...
    ibool useLinearBlits)
{
    ...
    dc->r.makeCurrent           = PACKED24_makeCurrent;
