...
static  void TIFFAPI horAcc8(TIFF*, tidata_t, tsize_t);
static  void TIFFAPI horAcc16(TIFF*, tidata_t, tsize_t);
static  void TIFFAPI swabHorAcc16(TIFF*, tidata_t, tsize_t);
static  void TIFFAPI horDiff8(TIFF*, tidata_t, tsize_t);
static  void TIFFAPI horDiff16(TIFF*, tidata_t, tsize_t);
static  int TIFFAPI PredictorDecodeRow(TIFF*, tidata_t, tsize_t, tsample_t);
static  int TIFFAPI PredictorDecodeTile(TIFF*, tidata_t, tsize_t, tsample_t);
static  int TIFFAPI PredictorEncodeRow(TIFF*, tidata_t, tsize_t, tsample_t);
static  int TIFFAPI PredictorEncodeTile(TIFF*, tidata_t, tsize_t, tsample_t);
