...
* Environment:  WinCE
*
* Description:  WinCE implementation for the SciTech cross platform
*               event library.
*
****************************************************************************/
    ...
    _EVT_mouseMoveHandler mouseMove)
{
    ...
    // TODO: signal(SIGABRT, _EVT_abort);
    // TODO: signal(SIGINT, _EVT_abort);
}
...
void EVT_exit(void)
{
    ...
    // TODO: signal(SIGABRT, SIG_DFL);
    // TODO: signal(SIGINT, SIG_DFL);
