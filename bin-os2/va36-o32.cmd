...
rem if not exist %VA365_PATH%\BIN\setenvtk.cmd echo "VisualAge C++ 3.65 not installed or incorrectly installed"
rem call %VA365_PATH%\BIN\setenvtk.cmd
...
echo IBM VisualAge C++ 3.65 OS/2 32-bit console compilation environment set up.
